...
router.post(
  ...
  async (req, res, next) => {
    await couponsController.create(req as AuthenticatedRequest, res, next);
  },
);
...
router.get(
  ...
  authorization([ROLES.ADMIN, ROLES.MANAGER]) as RequestHandler,
  async (req, res, next) => {
    await couponsController.findAll(req as AuthenticatedRequest, res, next);
  },
);
...
router.get(
  ...
  async (req, res, next) => {
    await couponsController.findOne(req as AuthenticatedRequest, res, next);
  },
);
...
router.put(
  ...
  authorization([ROLES.ADMIN, ROLES.MANAGER]) as RequestHandler,
  async (req, res, next) => {
    await couponsController.update(req as AuthenticatedRequest, res, next);
  },
);
